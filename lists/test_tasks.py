...
class AutoUncheckCase(TestCase):
    def setUp(self) -> None:
        TodoItem.objects.create(name='recurring_with_due_date',
                                completed=True,
                                due_again_in=3,
                                )
        TodoItem.objects.create(name='recurring_without_due_date',
                                completed=True,
                                due_again_in=None,
                                )
    ...
    def test_uncheck(self):
        ...
        recurring_without_due_date = TodoItem.objects.get(name='recurring_without_due_date')
